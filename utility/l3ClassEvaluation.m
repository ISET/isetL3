function [X, y_pred, y_true, fig] = l3ClassEvaluation(l3t, thisClass, thisChannel, patchSz)
% Examine the accuracy of the kernel in its class, and show the kernel weights
%
% Syntax:
%   [X, y_pred, y_true, fig] = l3ClassEvaluation(l3t, thisClass, thisChannel, patchSz)
%
% Brief description:
%
% Inputs:
