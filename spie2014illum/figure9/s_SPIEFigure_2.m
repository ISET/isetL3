      ...
      for k = 1:2
        for l = 1:2
          ...
          for m = 1:length(colors)
            ...
            switch i
              case 1
                filtersD65sub = [filtersD65sub;filtersD65(:).global];
                filtersAltsub = [filtersAltsub;filtersAlt(:).global];
                type = 'global';
              case 2
                filtersD65sub = [filtersD65sub;filtersD65(:).flat];
                filtersAltsub = [filtersAltsub;filtersAlt(:).flat];
                type = 'flat';
              case 3
                filtersD65sub = [filtersD65sub;cell2mat([filtersD65(:).texture])];
                filtersAltsub = [filtersAltsub;cell2mat([filtersAlt(:).texture])];
                type = 'texture';
              otherwise
            end
