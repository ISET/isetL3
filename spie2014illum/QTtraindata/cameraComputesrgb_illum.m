function [srgbResult, srgbIdeal, raw, camera] = ...
    cameraComputesrgb_illum(camera, sceneName, meanLuminance, sz, scenefov, ...
...
% Change illuminant to training illuminant
scene = sceneAdjustIlluminant(scene, cameraGet(camera, 'l3 training illuminant'));
